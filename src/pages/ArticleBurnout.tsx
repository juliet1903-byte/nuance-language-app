  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
      ...
      <header className="sticky top-0 z-10 bg-background/80 backdrop-blur-md border-b border-border/30 px-5 py-4 flex items-center gap-3">
        ...
        <span className="text-sm font-semibold truncate">Quiet Cracking or Burning Out?</span>
      </header>
      ...
      <article className="max-w-2xl mx-auto px-5 pb-20">
        ...
        <div className="flex items-center gap-4 text-xs text-muted-foreground mb-8">
          ...
          <span className="bg-card px-2.5 py-1 rounded-full font-medium">Wellbeing</span>
        </div>
        ...
        <div className="space-y-8 text-foreground">
          ...
          <section>
            <h2 className="text-xl font-bold mb-4">The Early Warning Signs</h2>
            <p className="text-muted-foreground text-sm mb-4">Burnout does not start with exhaustion. It starts with subtle changes in behaviour:</p>
            <div className="space-y-3">
              {earlyWarnings.map((sign, i) => (
                <div key={i} className="flex gap-3 bg-card rounded-xl p-4 border border-border/50">
                  ...
                  <p className="text-sm text-muted-foreground leading-relaxed">{sign}</p>
                </div>
              ))}
            </div>
          ...
          <section>
            <h2 className="text-xl font-bold mb-3">Why Professional Culture Makes It Hard to Raise Burnout</h2>
          ...
          <section>
            <h2 className="text-xl font-bold mb-3">What to Say to Your Manager</h2>
            <p className="text-muted-foreground text-sm leading-relaxed mb-4">
            ...
            <div className="space-y-3 mb-6">
              ...
              <div className="bg-card rounded-xl p-4 border border-border/50">
                <p className="text-xs font-bold text-muted-foreground uppercase tracking-wider mb-2">❌ Weak opening</p>
                <p className="text-sm italic text-muted-foreground">"I'm really struggling at the moment. I feel completely overwhelmed and I don't think I can keep this up."</p>
              </div>
              <div className="bg-card rounded-xl p-4 border border-cta/30">
                <p className="text-xs font-bold text-cta uppercase tracking-wider mb-2">✅ Strong opening</p>
                <p className="text-sm italic text-foreground">"I want to talk about the current workload. Over the past two months, I've taken on [X], [Y], and [Z emergency fix], and I'm now working evenings and weekends to keep up. That pace is not sustainable, and I want to find a way to reset expectations before it affects the quality of my work."</p>
              </div>
            </div>
            ...
            <div className="space-y-3 mb-6">
              ...
              <ul className="space-y-2 text-sm text-muted-foreground">
                <li className="flex gap-2"><span className="text-foreground">•</span> "Can we deprioritise [X] or push [Y] to next quarter?"</li>
                <li className="flex gap-2"><span className="text-foreground">•</span> "I'd like to hand off [Z task] to someone else so I can focus on the higher-impact work."</li>
                <li className="flex gap-2"><span className="text-foreground">•</span> "Can we limit my meeting load to mornings only for the next month?"</li>
              </ul>
            </div>
            ...
            <div className="space-y-3">
              ...
              <div className="bg-card rounded-xl p-4 border border-border/50">
                <p className="text-xs font-bold text-muted-foreground uppercase tracking-wider mb-2">❌ Low urgency (will be ignored)</p>
                <p className="text-sm italic text-muted-foreground">"At some point we should probably talk about workload. Let me know when you have time."</p>
              </div>
              <div className="bg-card rounded-xl p-4 border border-cta/30">
                <p className="text-xs font-bold text-cta uppercase tracking-wider mb-2">✅ High urgency (will be prioritised)</p>
                <p className="text-sm italic text-foreground">"I'd like to talk about this in our next one-to-one — or sooner if possible. I'm at the point where I need to make a change in the next two weeks or the quality of my work will start to slip."</p>
              </div>
            </div>
          </section>

          <section>
            <h2 className="text-xl font-bold mb-3">What to Say When a Colleague Is Burning Out</h2>
            <div className="space-y-3">
              {[
            ...
            <div className="bg-accent/10 border border-accent/20 rounded-xl p-4 mt-4">
              <p className="text-xs font-bold text-accent uppercase tracking-wider mb-1">Important</p>
              <p className="text-sm text-muted-foreground">Do not ask 'Are you burned out?' Most people will reflexively say no, even when the answer is yes. Ask about behaviour or offer concrete help instead.</p>
            </div>
          </section>

          <section>
            <h2 className="text-xl font-bold mb-3">The Language of Boundaries: Saying No Before You Break</h2>
            <div className="space-y-2">
              {[
          ...
          <section>
            <h2 className="text-xl font-bold mb-3">When It's Too Late: Signs of Irreversible Burnout</h2>
            <div className="space-y-3">
          ...
          <section>
            <h2 className="text-xl font-bold mb-3">What Recovery Actually Looks Like</h2>
            <p className="text-muted-foreground text-sm leading-relaxed mb-4">
            ...
            <ul className="space-y-2 text-sm text-muted-foreground">
              {[
                ...
                <li key={i} className="flex gap-2"><span className="text-cta font-bold shrink-0">→</span>{item}</li>
              ))}
            </ul>
          </section>
