    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <article className="max-w-2xl mx-auto px-5 pb-20">
        ...
        <div className="flex items-center gap-4 text-xs text-muted-foreground mb-8">
          <span className="flex items-center gap-1 text-sm"><Clock className="w-3.5 h-3.5" /> 10 min read</span>
        ...
        <div className="space-y-8">
          <section>
            ...
            <div className="bg-cta/10 border border-cta/20 rounded-xl p-4 mt-4">
              <p className="text-foreground text-base font-medium">The most dangerous miscommunications are the ones where both parties think they understood each other perfectly.</p>
            </div>
          </section>
          ...
          <section>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="bg-card rounded-xl p-4 border border-border/50">
                ...
                <p className="text-muted-foreground text-base">Northern European, North American, Australian. If you mean no, you say no. Silence is assumed to mean agreement.</p>
              </div>
              <div className="bg-card rounded-xl p-4 border border-border/50">
                <p className="font-semibold mb-2 text-base">🟠 High-context cultures</p>
                <p className="text-muted-foreground text-base">East Asian, South Asian, Middle Eastern, Southern European. Disagreement is signalled indirectly. Silence is often the opposite of agreement.</p>
              </div>
            </div>
          ...
          <section>
            ...
            <p className="text-muted-foreground mb-4 text-base">These phrases sound neutral or positive in English but often carry different meanings. Tap each card to reveal the real meaning.</p>
          ...
          <section>
            ...
            <p className="text-muted-foreground mb-6 text-base">Test your cross-cultural reading skills. Choose the best answer for each scenario.</p>
            ...
            <div className="space-y-6">
              ...
              <div key={qi} className="bg-card rounded-xl p-4 border border-border/50">
                  ...
                  <div className="space-y-2">
                    ...
                    if (submitted) {
                      if (isCorrect) style = "bg-green-500/10 border border-green-500/30 text-green-700 dark:text-green-400";else
                      if (isSelected && !isCorrect) style = "bg-destructive/10 border border-destructive/30 text-destructive";else
