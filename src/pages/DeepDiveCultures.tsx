    ...
    >
      <div className={`p-4 transition-all duration-300 ${flipped ? "bg-cta text-cta-foreground" : "bg-card"}`}>
        <div className="flex items-start justify-between gap-2">
          ...
          <RotateCcw className={`w-3.5 h-3.5 shrink-0 mt-0.5 transition-transform ${flipped ? "rotate-180 text-cta-foreground/70" : "text-muted-foreground"}`} />
        </div>
      </div>
    </button>
  );
...
const DeepDiveCultures = () => {
  ...
  const knowledgeCheck = [
    ...
    },
    {
      ...
      answer: "B",
      explanation: "This phrase clarifies without forcing direct confrontation. Options A and D are culturally tone-deaf.",
    },
  ];
  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
      <header className="sticky top-0 z-10 bg-background/80 backdrop-blur-md border-b border-border/30 px-5 py-4 flex items-center gap-3">
        ...
        <span className="text-sm font-semibold truncate">Reading Between Cultures</span>
      </header>
      ...
      <article className="max-w-2xl mx-auto px-5 pb-20">
        ...
        <div className="flex items-center gap-4 text-xs text-muted-foreground mb-8">
          ...
          <span className="bg-card px-2.5 py-1 rounded-full font-medium">Cross-Cultural</span>
        </div>
        ...
        <div className="space-y-8">
          <section>
            <p className="text-muted-foreground leading-relaxed">
              Working across cultures is not just about learning idioms or avoiding taboo topics. It is about understanding that the same words carry different social weight in different contexts — and that what counts as direct, polite, or professional varies far more than most people realise.
            </p>
            <p className="text-muted-foreground leading-relaxed mt-4">
              The biggest miscommunications in international teams do not come from language barriers. They come from <strong className="text-foreground">context mismatches</strong>. In high-context cultures, meaning is embedded in the situation, the relationship, and what is left unsaid. In low-context cultures, meaning is expected to be explicit, direct, and unambiguous.
            </p>
            <div className="bg-cta/10 border border-cta/20 rounded-xl p-4 mt-4">
              <p className="text-sm font-semibold text-foreground">The most dangerous miscommunications are the ones where both parties think they understood each other perfectly.</p>
            </div>
          </section>

          <section>
            <h2 className="text-xl font-bold mb-3">The Signal vs The Words</h2>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="bg-card rounded-xl p-4 border border-border/50">
                <p className="font-semibold text-sm mb-2">🔵 Low-context cultures</p>
                <p className="text-sm text-muted-foreground">Northern European, North American, Australian. If you mean no, you say no. Silence is assumed to mean agreement.</p>
              </div>
              <div className="bg-card rounded-xl p-4 border border-border/50">
                <p className="font-semibold text-sm mb-2">🟠 High-context cultures</p>
                <p className="text-sm text-muted-foreground">East Asian, South Asian, Middle Eastern, Southern European. Disagreement is signalled indirectly. Silence is often the opposite of agreement.</p>
              </div>
            </div>
            <p className="text-muted-foreground text-sm mt-4 leading-relaxed">
              In a meeting between high-context and low-context communicators, the high-context person thinks they have clearly signaled disagreement, and the low-context person thinks the issue has been resolved. Both leave the meeting believing the other understood them. Neither did.
            </p>
          </section>

          <section>
            <h2 className="text-xl font-bold mb-2">Common High-Context Signals</h2>
            <p className="text-muted-foreground text-sm mb-4">These phrases sound neutral or positive in English but often carry different meanings. Tap each card to reveal the real meaning.</p>
          ...
          <section>
            <h2 className="text-xl font-bold mb-3">How to Respond When You're Not Sure</h2>
          ...
          <section>
            <h2 className="text-xl font-bold mb-3">The Danger of 'Treating Everyone the Same'</h2>
            <p className="text-muted-foreground text-sm leading-relaxed mb-4">
              One of the most common mistakes in cross-cultural teams is the assumption that everyone should communicate the same way — usually meaning everyone should communicate like low-context, direct communicators.
            </p>
            <div className="bg-card rounded-xl p-4 border border-border/50 mb-4">
              <p className="text-sm text-muted-foreground leading-relaxed">
                The low-context communicator is seen as clear, decisive, and straightforward. The high-context communicator is seen as vague, indecisive, or passive-aggressive — even when they are following the norms of professional communication in their own culture.
              </p>
            </div>
            <div className="bg-cta/10 border border-cta/20 rounded-xl p-4">
              <p className="text-sm font-medium text-foreground">
                Cultural awareness is not about learning to speak like someone from another culture. It is about learning to recognise when communication styles are clashing — and knowing how to bridge the gap.
              </p>
            </div>
          </section>
          ...
          <section>
            ...
            <p className="text-muted-foreground text-sm mb-6">Test your cross-cultural reading skills. Choose the best answer for each scenario.</p>

            <div className="space-y-6">
              {knowledgeCheck.map((item, qi) => (
                <div key={qi} className="bg-card rounded-xl p-4 border border-border/50">
                  <p className="font-semibold text-sm mb-3">Q{qi + 1}. {item.q}</p>
