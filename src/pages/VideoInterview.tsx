  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
      <header className="sticky top-0 z-10 bg-background/80 backdrop-blur-md border-b border-border/30 px-5 py-4 flex items-center gap-3">
        ...
        <span className="font-semibold truncate text-base">How to Get Ready for an Interview</span>
      </header>
      ...
      <div className="max-w-2xl mx-auto px-5 pb-20">
        ...
        <div className="mb-6">
          ...
          <div className="flex items-center gap-4 text-xs text-muted-foreground">
            <span className="flex items-center gap-1 text-sm"><Clock className="w-3.5 h-3.5" /> 12 min</span>
        ...
        <div className="space-y-6">
          ...
          <section>
            <h2 className="text-lg mb-3 font-semibold">Key Phrases to Use</h2>
            <div className="space-y-3">
              {[
              ...
              <div key={item.context} className="bg-card rounded-xl p-4 border border-border/50">
                  <p className="font-bold text-muted-foreground uppercase tracking-wider mb-2 text-sm">{item.context}</p>
                  <p className="text-foreground italic text-base">"{item.phrase}"</p>
                </div>
              )}
            </div>
          </section>
          ...
          <section>
            <h2 className="text-lg mb-3 font-semibold">Common Mistakes to Avoid</h2>
            <div className="space-y-2">
              ...
              <div key={i} className="flex gap-3 bg-card rounded-xl p-3 border border-border/50">
                  ...
                  <p className="text-muted-foreground text-base">{mistake}</p>
                </div>
              )}
            </div>
          </section>
