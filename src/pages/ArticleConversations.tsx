  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
      <header className="sticky top-0 z-10 bg-background/80 backdrop-blur-md border-b border-border/30 px-5 py-4 flex items-center gap-3">
        ...
        <span className="text-sm font-semibold truncate">The Conversations Most People Avoid</span>
      </header>
      ...
      <article className="max-w-2xl mx-auto px-5 pb-20">
        ...
        <div className="flex items-center gap-4 text-xs text-muted-foreground mb-8">
          ...
          <span className="bg-card px-2.5 py-1 rounded-full font-medium">Communication</span>
        </div>
        ...
        <div className="space-y-8 text-foreground">
          ...
          <section>
            <h2 className="text-xl font-bold mb-4">Why Difficult Conversations Go Wrong</h2>
            <p className="text-muted-foreground text-sm mb-4">Most difficult conversations fail for one of three reasons:</p>
          ...
          <section>
            <h2 className="text-xl font-bold mb-4">Framework 1: What-Why-Next</h2>
            <p className="text-muted-foreground text-sm mb-4">The simplest and most versatile framework. It works for quick feedback, recurring issues, and situations where you need to be direct but not heavy-handed.</p>
            <div className="space-y-3">
              <div className="bg-card rounded-xl p-4 border border-border/50">
                <p className="font-semibold text-sm text-cta">What happened</p>
                <p className="text-sm text-muted-foreground mt-1 italic">"During Tuesday's standup, when the timeline question came up, you said 'that's not my problem' and moved on."</p>
              </div>
              <div className="bg-card rounded-xl p-4 border border-border/50">
                <p className="font-semibold text-sm text-cta">Why it mattered</p>
                <p className="text-sm text-muted-foreground mt-1 italic">"People stopped asking clarifying questions for the rest of the meeting, and two people came to me afterwards feeling unsure about next steps."</p>
              </div>
              <div className="bg-card rounded-xl p-4 border border-border/50">
                <p className="font-semibold text-sm text-cta">What next</p>
                <p className="text-sm text-muted-foreground mt-1 italic">"Going forward, even something like 'I don't have that answer right now, but I can find out' would help the team feel like they can ask without getting shut down."</p>
              </div>
            </div>
          </section>

          <section>
            <h2 className="text-xl font-bold mb-4">Framework 2: DESC</h2>
            <p className="text-muted-foreground text-sm mb-4">Use this when the feedback is formal, the issue is recurring, or you need a clear outcome.</p>
            <div className="space-y-3">
              {[
          ...
          <section>
            <h2 className="text-xl font-bold mb-4">Framework 3: The Contrast Method</h2>
            <p className="text-muted-foreground text-sm mb-4">Works when there is an obvious gap between what was agreed and what actually happened.</p>
          ...
          <section>
            <h2 className="text-xl font-bold mb-4">The Most Common Mistake: Defending Your Intent</h2>
            ...
            <div className="space-y-3">
              <div className="bg-card rounded-xl p-4 border border-border/50">
                <p className="text-xs font-bold text-muted-foreground uppercase tracking-wider mb-2">❌ Defending intent first</p>
                <p className="text-sm italic text-muted-foreground">"I'm not sexist — I didn't mean it like that. You've misunderstood what I was trying to say."</p>
              </div>
              <div className="bg-card rounded-xl p-4 border border-cta/30">
                <p className="text-xs font-bold text-cta uppercase tracking-wider mb-2">✅ Acknowledging impact first</p>
                <p className="text-sm italic text-foreground">"That wasn't my intention — and I can see how it landed. I'm sorry. I'll be more careful. Let me explain what I was trying to say, and you can tell me if that changes how it felt."</p>
              </div>
            </div>
          </section>

          <section>
            <h2 className="text-xl font-bold mb-4">How to Start Without Escalating</h2>
            <p className="text-muted-foreground text-sm mb-4">The opening sets the tone for everything that follows. Here are openers that work:</p>
            <div className="space-y-3">
              {[
          ...
          <section>
            <h2 className="text-xl font-bold mb-4">When the Other Person Gets Defensive</h2>
            <p className="text-muted-foreground text-sm mb-4">Your job is not to match their energy. It is to stay calm, restate what you need, and give them space:</p>
            <div className="space-y-3">
              {[
          ...
          <section>
            <h2 className="text-xl font-bold mb-4">The Conversations You Should Not Have</h2>
            <div className="space-y-3">
              {[
