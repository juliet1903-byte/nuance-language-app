  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
      <header className="sticky top-0 z-10 bg-background/80 backdrop-blur-md border-b border-border/30 px-5 py-4 flex items-center gap-3">
        ...
        <span className="text-sm font-semibold truncate">How to Grow Professional Relationships</span>
      </header>
      ...
      <div className="max-w-2xl mx-auto px-5 pb-20">
        ...
        <div className="mb-6">
          ...
          <h1 className="text-2xl md:text-3xl font-bold leading-tight mb-3">How to Grow Professional Relationships</h1>
