  ...
  const features = [
    {
      icon: Zap,
      title: "Vibe IQ",
      description: "Track your communication impact score across every interaction.",
    },
    {
      icon: Route,
    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <section className="text-center px-6 pt-12 pb-8 max-w-3xl mx-auto">
        <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold tracking-tight leading-tight mb-5">
          Speak with Impact.{" "}
          <span className="text-cta">Lead with Nuance.</span>
        </h1>
        <p className="text-base md:text-lg text-muted-foreground max-w-xl mx-auto mb-8 leading-relaxed">
          You've mastered the basics. Now, master the nuance. Refactor your business communication to lead, influence, and impact.
        </p>
