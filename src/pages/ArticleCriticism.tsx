    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <article className="max-w-2xl mx-auto px-5 pb-20">
        ...
        <div className="flex items-center gap-4 text-xs text-muted-foreground mb-8">
          <span className="flex items-center gap-1 text-sm"><Clock className="w-3.5 h-3.5" /> 8 min read</span>
          <span className="bg-card px-2.5 py-1 rounded-full font-medium text-sm">Feedback</span>
        </div>
        ...
        <div className="space-y-8 text-foreground">
          ...
          <section>
            ...
            <p className="text-muted-foreground mb-4 text-base">When someone tells you that something you did caused a problem, your brain has about three seconds to decide how to respond. Most people default to one of four instinctive responses:</p>
          ...
          <section>
            <h2 className="text-xl mb-4 font-semibold">The Only Response That Keeps the Conversation Open</h2>
            <div className="bg-cta/10 border border-cta/20 rounded-xl p-4 mb-4">
              <p className="font-medium text-foreground italic text-base">
          ...
          <section>
            <h2 className="text-xl mb-4 font-semibold">How to Ask for Specifics Without Sounding Defensive</h2>
            <p className="text-muted-foreground mb-4 text-base">Vague feedback is useless. Your job when you receive vague feedback is to ask for specifics in a way that does not sound like you are pushing back:</p>
            <div className="space-y-3">
              {[
          ...
          <section>
            <h2 className="text-xl mb-4 font-semibold">What to Do When the Feedback Is Unfair</h2>
            ...
            <div className="space-y-3">
              <div className="bg-card rounded-xl p-4 border border-border/50">
                <p className="text-base font-medium">Step 1: Acknowledge their experience</p>
                <p className="text-muted-foreground mt-1 italic text-base">"I can see why it looked that way from your perspective."</p>
              </div>
              <div className="bg-card rounded-xl p-4 border border-border/50">
                <p className="text-base font-medium">Step 2: Add context without framing it as a correction</p>
                <p className="text-muted-foreground mt-1 italic text-base">"Let me share what was happening on my side, and you can tell me if that changes how it felt."</p>
              </div>
            </div>
            ...
            <div className="space-y-3 mt-4">
              <div className="bg-card rounded-xl p-4 border border-border/50">
                ...
                <p className="italic text-muted-foreground text-base">"You've misunderstood what happened. I didn't have the information I needed to make that call."</p>
              </div>
              <div className="bg-card rounded-xl p-4 border border-cta/30">
                ...
                <p className="italic text-foreground text-base">"I can see why it looked that way. From my side, I didn't have X at the time, which is why I made the call I did. If there's a way to flag that earlier in future, that would help."</p>
              </div>
            </div>
          </section>

          <section>
            <h2 className="text-xl mb-4 font-semibold">The Danger of Collapsing</h2>
            <p className="text-muted-foreground leading-relaxed mb-4 text-base">
            ...
            <div className="space-y-3">
              <div className="bg-card rounded-xl p-4 border border-border/50">
                ...
                <p className="italic text-muted-foreground text-base">"I know, I know — I'm just not good at that. I'll try harder. I'm sorry."</p>
              </div>
              <div className="bg-card rounded-xl p-4 border border-cta/30">
                <p className="text-xs font-bold text-cta uppercase tracking-wider mb-2">✅ Learning</p>
                <p className="italic text-foreground text-base">"That's useful — thank you. Can I ask what specifically felt off? I want to make sure I'm addressing the right thing."</p>
              </div>
            </div>
          </section>

          <section>
            <h2 className="text-xl mb-4 font-semibold">When to Push Back</h2>
            <p className="text-muted-foreground leading-relaxed mb-4 text-base">
          ...
          <section>
            <h2 className="text-xl mb-4 font-semibold">Deciding What to Do With the Feedback</h2>
            <p className="text-muted-foreground leading-relaxed mb-4 text-base">
