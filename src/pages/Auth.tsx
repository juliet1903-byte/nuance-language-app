          ...
          <Tabs defaultValue="signin" className="w-full">
            ...
            <TabsContent value="signin">
              <button
                ...
                className="w-full flex items-center justify-center gap-3 py-3 rounded-xl border border-border bg-card font-semibold text-sm hover:bg-muted/50 transition-colors disabled:opacity-50">
