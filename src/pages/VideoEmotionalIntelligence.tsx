  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
      <header className="sticky top-0 z-10 bg-background/80 backdrop-blur-md border-b border-border/30 px-5 py-4 flex items-center gap-3">
        ...
        <span className="text-sm font-semibold truncate">The 4 Domains of Emotional Intelligence</span>
      </header>
      ...
      <div className="max-w-2xl mx-auto px-5 pb-20">
        ...
        <div className="mb-6">
          ...
          <h1 className="text-2xl md:text-3xl font-bold leading-tight mb-3">The 4 Domains of Emotional Intelligence</h1>
          <div className="flex items-center gap-4 text-xs text-muted-foreground">
            <span className="flex items-center gap-1"><Clock className="w-3.5 h-3.5" /> 6 min</span>
            <span className="bg-card px-2.5 py-1 rounded-full font-medium">Leadership</span>
          </div>
        </div>
        ...
        <div className="space-y-6">
          <section>
            <h2 className="text-lg font-bold mb-3">The 4 Domains</h2>
