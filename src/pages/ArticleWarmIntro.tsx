    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <article className="max-w-2xl mx-auto px-5 pb-20">
        ...
        <div className="flex items-center gap-4 text-xs text-muted-foreground mb-8">
          ...
          <span className="bg-card px-2.5 py-1 rounded-full font-medium">Networking</span>
        </div>
        ...
        <div className="prose prose-sm md:prose-base max-w-none space-y-8 text-foreground">
          ...
          <section>
            ...
            <div className="bg-cta/10 border border-cta/20 rounded-xl p-4 mt-4">
              ...
              <p className="text-sm text-foreground mt-1">A warm introduction answers the question 'Why should I care?' before the recipient has to ask it.</p>
            </div>
            <p className="leading-relaxed text-muted-foreground mt-4">
          ...
          <section>
            <h2 className="text-xl font-bold mb-3">The Anatomy of a Strong Introduction</h2>
            <p className="leading-relaxed text-muted-foreground">
          ...
          <section>
            ...
            <div className="space-y-3">
              <div className="bg-card rounded-xl p-4 border border-border/50">
                ...
                <p className="text-sm italic text-muted-foreground">"Hi [Name], I'd like to introduce you to [Name]. They work in tech and I thought you might have overlapping interests."</p>
              </div>
              <div className="bg-card rounded-xl p-4 border border-cta/30">
                ...
                <p className="text-sm italic text-foreground">"Hi [Name], I'm introducing you to [Name], who is leading a project on API security at [Company] — an area I know you've been thinking about for your own infrastructure."</p>
              </div>
            </div>
          </section>
          ...
          <section>
            ...
            <div className="space-y-3">
              <div className="bg-card rounded-xl p-4 border border-border/50">
                ...
                <p className="text-sm italic text-muted-foreground">"[Name A] is an expert in machine learning. [Name B] is working on an ML project. I think you should connect."</p>
              </div>
              <div className="bg-card rounded-xl p-4 border border-cta/30">
                <p className="text-xs font-bold text-cta uppercase tracking-wider mb-2">💼 Strong value prop</p>
                <p className="text-sm italic text-foreground">"[Name A] has been through three ML deployment cycles at scale and might have useful perspectives on the latency issues you mentioned last week. [Name B] is currently solving a similar problem and would benefit from hearing how you approached it."</p>
              </div>
            </div>
          </section>
          ...
          <section>
            ...
            <div className="space-y-3">
              <div className="bg-card rounded-xl p-4 border border-border/50">
                <p className="text-xs font-bold text-muted-foreground uppercase tracking-wider mb-2">❌ Weak</p>
                <p className="text-sm italic text-muted-foreground">"Let me know if you'd be open to a call sometime."</p>
              </div>
              <div className="bg-card rounded-xl p-4 border border-cta/30">
                <p className="text-xs font-bold text-cta uppercase tracking-wider mb-2">✅ Strong</p>
                <p className="text-sm italic text-foreground">"If this sounds useful, I can make an intro over email. If not, no worries at all — I know your calendar is full."</p>
              </div>
            </div>
          </section>

          <section>
            <h2 className="text-xl font-bold mb-3">When to Say No to an Introduction Request</h2>
            <p className="leading-relaxed text-muted-foreground mb-4">
            ...
            <ul className="space-y-2 text-muted-foreground text-sm">
              <li className="flex gap-2"><span className="text-foreground font-bold shrink-0">•</span> You don't know one of the parties well enough to vouch for them.</li>
              <li className="flex gap-2"><span className="text-foreground font-bold shrink-0">•</span> The value exchange is one-sided — the introduction only benefits one party.</li>
              <li className="flex gap-2"><span className="text-foreground font-bold shrink-0">•</span> You have not asked permission from both parties first.</li>
            </ul>
            <div className="bg-card rounded-xl p-4 border border-border/50 mt-4">
              <p className="text-sm text-muted-foreground italic">If you cannot explain why the introduction is valuable in two sentences, you have not thought about it enough to make it.</p>
            </div>
          </section>

          <section>
            <h2 className="text-xl font-bold mb-3">The Double Opt-In</h2>
            <p className="leading-relaxed text-muted-foreground mb-4">
              The double opt-in is the standard method for professional introductions. It works like this:
            </p>
            <ol className="space-y-2 text-sm text-muted-foreground list-none">
              <li className="flex gap-3"><span className="bg-cta text-cta-foreground rounded-full w-5 h-5 flex items-center justify-center text-xs font-bold shrink-0 mt-0.5">1</span> Message Person A asking if they're open to the intro, with specific reason.</li>
              <li className="flex gap-3"><span className="bg-cta text-cta-foreground rounded-full w-5 h-5 flex items-center justify-center text-xs font-bold shrink-0 mt-0.5">2</span> If A says yes, message Person B with the same structure.</li>
              <li className="flex gap-3"><span className="bg-cta text-cta-foreground rounded-full w-5 h-5 flex items-center justify-center text-xs font-bold shrink-0 mt-0.5">3</span> If both say yes, make the introduction with full context for both parties.</li>
              <li className="flex gap-3"><span className="bg-cta text-cta-foreground rounded-full w-5 h-5 flex items-center justify-center text-xs font-bold shrink-0 mt-0.5">4</span> If either says no or does not respond, do not make the introduction.</li>
            </ol>
          </section>
          ...
          <section>
            <h2 className="text-xl font-bold mb-3">Final Thought: Introductions Are a Long Game</h2>
            <p className="leading-relaxed text-muted-foreground">
