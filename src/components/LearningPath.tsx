  ...
  return (
    <div className="bg-card rounded-2xl p-5 shadow-sm">
      <div className="flex items-center justify-between mb-4">
        <h2 className="text-lg font-serif">My Learning Path</h2>
        <span className="flex items-center gap-1 text-sm text-accent bg-accent/10 px-3 py-1 rounded-full">
          👍 7
        </span>
      </div>
      ...
      <div className="space-y-0">
        ...
        <div key={step.id} className="flex gap-3">
            ...
            <div className="w-0.5 h-8 bg-border my-0 border border-solid border-secondary" />
            }
            </div>
